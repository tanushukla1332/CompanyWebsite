...
export default function DeatilP2({title}){
    return(
       <>
       <Row className='justify-content-center align-items-center bgSection gap-5'>
       <Col md={7}>
       <div className='pt-3'>
       <h2 className='hed2 text-white'>FOREVER NEW</h2>
      ...
      <ul>
      <li className='flex gap-[65px] text-[#3b7fbf] font-medium md:text-xl text-sm py-3 border-bottom '><span>BRAND</span> <span>Forever New</span></li>
      <li className='flex gap-5 text-[#3b7fbf] font-medium md:text-xl text-sm py-3 border-bottom'><span>PROJECT <br />  STARTED</span> <span>January 2018</span></li>
      <li className='flex gap-5 text-[#3b7fbf] font-medium md:text-xl text-sm py-3 border-bottom'><span>SERVICES</span> <span>	
      Ecommerce Site  Design &  <br /> Development</span></li>
      <li className='flex gap-2 text-[#3b7fbf] font-medium md:text-xl text-sm py-3 border-bottom'><span> TECHNOLOGY :</span> <span>	
      Magento 
       Ecommerce</span></li>
       ...
       <Row className='justify-content-center align-items-center py-5'
            ...
            >
                <Col md={5}>
                    <div>
                        <h2 className='hed2'>FOREVER NEW</h2>
