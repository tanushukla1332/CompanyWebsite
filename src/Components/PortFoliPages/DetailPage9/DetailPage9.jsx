...
export default function DeatilP9({ title }) {
    return (
        <>
            <Row className='justify-content-center align-items-center bgSection gap-5'>
                <Col md={6}>
                    <div className='pt-3'>
                        <h2 className='hed2 text-white'>SOLOS (FURNITURE STORE)</h2>
                ...
                <Col md={4}>
                    <div className='bg-white py-2 my-3 rounded-2'>
                        ...
                        SOLOS <br /> (FURNITURE STORE)</span></li>
                            ...
                            <li className='flex gap-5 text-[#3b7fbf] font-medium md:text-xl text-sm py-3 border-bottom'><span>SKILL</span> <span>
                                WEBSITE DESIGN/ WORDPRESS</span></li>
                      
                            <li className='flex gap-5 text-[#3b7fbf] font-medium md:text-xl text-sm py-3 border-bottom'><span>TIME</span> <span>
                                02 WEEKS</span></li>
                        </ul>
                    </div>
            ...
            >
                <Col md={5}>
                    <div>
                        <h2 className='hed2'>SOLOS (FURNITURE STORE)</h2>
