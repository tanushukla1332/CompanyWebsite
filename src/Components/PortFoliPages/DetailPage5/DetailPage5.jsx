...
export default function DeatilP5({title}){
    return(
       <>
       <Row className='justify-content-center align-items-center bgSection gap-5'>
       <Col md={5}>
       <div className='pt-3'>
       <h2 className='hed2 text-white'>LUMINOUS PRINTING PROJECT</h2>
      ...
      <ul>
      <li className='flex gap-[75px] text-[#3b7fbf] font-medium md:text-xl text-sm py-3 border-bottom'><span> CLIENT</span> <span>	
Luminous Printing</span></li>
      <li className='flex gap-[95px] text-[#3b7fbf] font-medium md:text-xl text-sm py-3 border-bottom '><span>DATE</span> <span>	
      7/8/2018</span></li>
    
      <li className='flex gap-5 text-[#3b7fbf] font-medium md:text-xl text-sm py-3 border-bottom'><span>SERVICES</span> <span>	
      Website  Design Development</span></li>
      
<li className='flex gap-[95px] text-[#3b7fbf] font-medium md:text-xl text-sm py-3 border-bottom'><span> TIME</span> <span>	
...
02 WEEKS</span></li>
       ...
       <Row className='justify-content-center align-items-center py-5'
            ...
            >
                <Col md={5}>
                    <div>
                        <h2 className='hed2'>LUMINOUS PRINTING</h2>
