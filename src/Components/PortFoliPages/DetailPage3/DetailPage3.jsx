...
export default function DeatilP3({title}){
    return(
       <>
       <Row className='justify-content-center align-items-center bgSection gap-5'>
       <Col md={6}>
       <div className='pt-3'>
       <h2 className='hed2 text-white '>EMPIRE FURNITURE</h2>
      ...
      <ul>
      <li className='flex gap-4 text-[#3b7fbf] font-medium md:text-xl text-sm py-3 border-bottom '><span>CLIENT</span> <span>Empire Furniture</span></li>
...
Seo & Website Development</span></li>
       ...
       <Row className='justify-content-center align-items-center py-5'
            ...
            >
                <Col md={5}>
                    <div>
                        <h2 className='hed2'>EMPIRE FURNITURE</h2>
