...
export default function DeatilP7({ title }) {
    return (
        <>
            ...
            <Row className='justify-content-center align-items-center bgSection gap-5'>
                <Col md={6}>
                    <div className='pt-3'>
                        <h2 className='hed2 text-white'>TRIBE CAR RENTAL</h2>
                ...
                <Col md={4}>
                    <div className='bg-white py-2 my-3 rounded-2'>
                        ...
                        TRIBE CAR  RENTAL COMPANY</span></li>
                            ...
                            <li className='flex gap-5 text-[#3b7fbf] font-medium md:text-xl text-sm py-3 border-bottom'><span>SKILL</span> <span>
                                SEO/ WEBSITE DEVELOPMENT</span></li>
            ...
            >
                <Col md={5}>
                    <div>
                        <h2 className='hed2'>TRIBE CAR RENTAL</h2>
