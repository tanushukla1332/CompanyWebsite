        ...
        search engine marketing Services, SEM Services'/>
            ...
            <Row className='justify-content-center align-items-center gap-5 py-5 bgrem' style={{ backgroundImage: "url('Image/blue.png')", backgroundSize: "50%", backgroundPosition: "right", backgroundRepeat: "no-repeat" }} >
                <Col md={5}>
                    ...
                    <p className='para text-left'>PPC, or Pay-Per-Click advertising, is a digital marketing model where advertisers pay a fee each time their ad is clicked. It's an effective way to reach potential customers at the right moment, as your ads appear when users search for keywords related to your business on search engines like Google or Bing, or when they browse websites within your target audience.</p>
