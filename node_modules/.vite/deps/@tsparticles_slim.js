...
// node_modules/@tsparticles/updater-color/browser/Utils.js
...
// node_modules/@tsparticles/updater-opacity/browser/Utils.js
...
// node_modules/@tsparticles/updater-size/browser/Utils.js
...
var EmojiDrawer = class {
  ...
  destroy() {
    for (const [key, emojiData] of this._emojiShapeDict) {
      emojiData instanceof ImageBitmap && (emojiData == null ? void 0 : emojiData.close());
...
var ImageDrawer = class {
  ...
  draw(data) {
    const { context, radius, particle, opacity, delta } = data, image = particle.image, element = image == null ? void 0 : image.element;
    if (!image) {
      return;
    }
    context.globalAlpha = opacity;
...
var PolygonDrawerBase = class {
  ...
  getSidesCount(particle) {
    ...
    return Math.round(getRangeValue((polygon == null ? void 0 : polygon.sides) ?? 5));
  }
};
...
var StarDrawer = class {
  ...
  getSidesCount(particle) {
    ...
    return Math.round(getRangeValue((star == null ? void 0 : star.sides) ?? 5));
  }
  particleInit(container, particle) {
    const star = particle.shapeData;
    particle.starInset = getRangeValue((star == null ? void 0 : star.inset) ?? 2);
  }
};
...
// node_modules/@tsparticles/updater-stroke-color/browser/Utils.js
