...
// node_modules/@tsparticles/engine/browser/Core/Utils/Range.js
var Range = class {
  constructor(x, y) {
    this.position = {
      x,
...
// node_modules/@tsparticles/engine/browser/Core/Utils/Rectangle.js
...
// node_modules/@tsparticles/engine/browser/Core/Utils/Circle.js
...
var QuadTree = class _QuadTree {
  constructor(rectangle, capacity) {
    ...
    this._subdivide = () => {
      ...
      for (let i = 0; i < 4; i++) {
        this._subs.push(new _QuadTree(new Rectangle(x + width * 0.5 * (i % 2), y + height * 0.5 * (Math.round(i * 0.5) - i % 2), width * 0.5, height * 0.5), capacity2));
      }
      this._divided = true;
    };
    this._points = [];
...
var Engine = class {
  ...
  async load(params) {
    var _a;
    const id = params.id ?? ((_a = params.element) == null ? void 0 : _a.id) ?? `tsparticles${Math.floor(getRandom() * 1e4)}`, { index, url } = params, options = url ? await getDataFromUrl({ fallback: params.options, url, index }) : params.options;
...
//# sourceMappingURL=chunk-P363A5GL.js.map
